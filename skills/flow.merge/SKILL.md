  ...
  "questions": [
    {
      ...
      "options": [
        {
          "label": "Local merge (Recommended)",
          "description": "Close phase locally - commit changes but skip push/PR/merge"
        },
        {
          "label": "Cancel",
          "description": "Stop and configure git remote first"
        }
      ],
      "multiSelect": false
    }
      ...
      "options": [
        {
          ...
          "description": "Include everything in the phase commit"
        },
        {
          "label": "Review first",
          "description": "Show me the changes before proceeding"
        },
  ...
  "questions": [
    {
      ...
      "options": [
        ...
        {
          "label": "Show details",
          "description": "Display verification instructions and test steps"
        },
        {
          "label": "Skip gate",
  ...
  "questions": [
    {
      ...
      "options": [
        {
          "label": "Delete archive (Recommended)",
          "description": "Archive is in git history if needed later"
        },
